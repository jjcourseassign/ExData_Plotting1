...
# Plot 1
plot(pwData[, dateTime], pwData[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(pwData[, dateTime],pwData[, Voltage], type="l", xlab="datetime", ylab="Voltage")
...
# Plot 4
plot(pwData[, dateTime], pwData[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
